...
public class CustomLoginDialog {
        ...
        private void buildImage() {
                ...
                canvas.addPaintListener(new PaintListener() {
                        ...
                        public void paintControl(final PaintEvent e) {
                                e.gc.drawImage(CustomLoginDialog.this.image == null ? createDefaultImage(e.width, e.height) : CustomLoginDialog.this.image, 0, 0);
                        }
                });
        ...
        private void buildLogin() {
                ...
                if (this.autorizedLogin != null && !this.autorizedLogin.isEmpty()) {
                        ...
                        combo.addModifyListener(new ModifyListener() {
                                ...
                                @Override
                                public void modifyText(final ModifyEvent e) {
                                        CustomLoginDialog.this.login = combo.getText();
                                        changeButtonOkState();
                                }
                        });
                } else {
                        ...
                        text.addModifyListener(new ModifyListener() {
                                ...
                                @Override
                                public void modifyText(final ModifyEvent e) {
                                        CustomLoginDialog.this.login = text.getText();
                                        changeButtonOkState();
                                }
                        });
                }
        ...
        private void buildPassword() {
                ...
                text.addModifyListener(new ModifyListener() {
                        ...
                        @Override
                        public void modifyText(final ModifyEvent e) {
                                CustomLoginDialog.this.password = text.getText();
                                changeButtonOkState();
                        }
                });
        ...
        private void buildButtons() {
                ...
                this.buttonOk.addSelectionListener(new SelectionAdapter() {
                        ...
                        public void widgetSelected(final SelectionEvent selectionEvent) {
                                try {
                                        CustomLoginDialog.this.verifier.authenticate(CustomLoginDialog.this.login, CustomLoginDialog.this.password);
                                        CustomLoginDialog.this.returnedValue = true;
                                        CustomLoginDialog.this.shell.dispose();
                                } catch (final Exception e) {
                                        Dialog.error(ResourceManager.getLabel(ResourceManager.LOGIN_FAILED), e.getMessage());
                                        for (final Control control : CustomLoginDialog.this.shell.getChildren()) {
                ...
                buttonCancel.addSelectionListener(new SelectionAdapter() {
                        ...
                        public void widgetSelected(final SelectionEvent e) {
                                CustomLoginDialog.this.returnedValue = false;
                                CustomLoginDialog.this.shell.dispose();
                        }
