<!-- main-box begin-->
						<div class="main-box"   style="background-image:url('/images/starliner_blau_PictureGalleryII.jpg');background-color:#000001;" >
							<div class="inner">   
							 	<img alt="" src="images/slogan_2.jpg" />
									<ul>
										 <li><a href="#">Kolay Kurulum, Kolay Kullanım</a></li>
										 <li><a href="#">Windows ve Linux Server Desteği</a></li>
