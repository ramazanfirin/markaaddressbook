...
/**
 * DataEntryDialog class uses <code>org.eclipse.swt 
 * libraries to implement a dialog that accepts basic personal information that
 * is added to a <code>Table widget or edits a TableItem entry 
 * to represent the entered data.
 */
public class DriverEntryDialog {
...
public DriverEntryDialog(Shell parent) {
...
/**
 * Returns the contents of the <code>Text widgets in the dialog in a 
 * <code>String array.
 *
 * @return	String[]	
...
/** 
 * Opens the dialog in the given state.  Sets <code>Text widget contents 
...
/**
 * Sets the values of the <code>Text widgets of the dialog to
